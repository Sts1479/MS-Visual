...
namespace dross {
	...
	private: System::Windows::Forms::TextBox^  Permeability;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Permeability = (gcnew System::Windows::Forms::TextBox());
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(384, 409);
			...
			this->label4->Location = System::Drawing::Point(39, 336);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(144, 13);
			this->label4->TabIndex = 8;
			this->label4->Text = L"Магнитная проницаемость";
			// 
			// label5
			// 
			...
			// Permeability
			// 
			this->Permeability->Location = System::Drawing::Point(208, 336);
			this->Permeability->Name = L"Permeability";
			this->Permeability->Size = System::Drawing::Size(100, 20);
			this->Permeability->TabIndex = 27;
			this->Permeability->Text = L"0";
			// 
			// Coils
			// 
			...
			this->radioButton1->Location = System::Drawing::Point(386, 347);
			...
			this->radioButton2->Location = System::Drawing::Point(509, 347);
			...
			this->label16->Location = System::Drawing::Point(452, 318);
			...
			this->ClientSize = System::Drawing::Size(705, 507);
 ...
 private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) 
		 {
			 ...
			 float *mass = new float[];
				...
				{
				mass=Induct(N,mu,l1vn,l1vt,l2vn,l2vt,h);
				...
				Ind=mass[0];
				mu_s=Saturation(N, mu, mass[2]*100, I);
...
//////////////////////
			 else if (radioflag==2)
			 {
				...
				Sc=Sc/10000;
				lsr=lsr/100;
				Ind=Induct1(N,mu,kf,lsr,Sc);
				Inductance->Text=System::Convert::ToString(Ind);
				lsr=lsr*100;
				mu_s=Saturation(N, mu, lsr, I);
				Perm_sat->Text=System::Convert::ToString(mu_s);
...
private: System::Void checkBox1_CheckedChanged(System::Object^  sender, System::EventArgs^  e) {
			 if (checkBox1->Checked)
      {
          ...
          Permeability->Text=System::Convert::ToString(mu_s);
      }
      else
      {
         Permeability->Text=System::Convert::ToString(mu);
      }
